...
const Project = ({ item }) => {
  return (
    <Link to={`/projectinfo/${item.id}`} className="max-w-sm hover:bg-slate-100 hover:cursor-pointer rounded bg-slate-400 overflow-hidden shadow-lg">
      <h2 className="text-center mt-3 font-bold text-2xl">Project</h2>
